...
import com.my.mall.api.mall.param.MallUserLoginParam;
import com.my.mall.api.mall.param.MallUserRegisterParam;
...
import com.my.mall.api.mall.vo.UserVO;
...
public class NewBeeMallPersonalAPI {
    ...
    public Result<UserVO> getUserDetail(@TokenToMallUser MallUser loginMallUser) {
        //已登录则直接返回
